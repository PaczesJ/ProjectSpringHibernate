        ...
        <div id="content">
                        ...
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                <div class="dropdown-list-image mr-3">
                                    <img class="rounded-circle" src="theme/img/undraw_profile_1.svg" alt="...">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href='<c:url value="/trainingPlan/add"/>'
                       class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                            class="fas fa-download fa-sm text-white-50"></i>Add a Training Plan</a>
                </div>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header">
                        <h6 class="m-0 font-weight-bold text-primary">Training Plan list</h6>
                    </div>
                    <div class="card-body">
                        <table class="table">
                            <tr>
                            ...
                            <c:forEach items="${trainingPlans}" var="trainingPlan">
                                <tr>
                                    ...
                                    <td>
                                        <a href="/trainingPlan/details/${trainingPlan.id}">Details</a>
                                        <a href="/trainingPlan/edit/${trainingPlan.id}">Edit</a>
                                        <a class="confirmDelete"
                                           href="/trainingPlan/delete/${trainingPlan.id}">Delete</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </table>
