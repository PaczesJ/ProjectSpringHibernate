...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<c:url value="/dashboard"/>p">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href='<c:url value="/exercise/exercises"/>'
                       class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                            class="fas fa-download fa-sm text-white-50"></i>List of Exercises</a>
                </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form:form method="post" modelAttribute="exercise">
                            ...
                            <input type="submit" value="SaveExercise">
                        </form:form>
                    </div>
                </div>
