        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href='<c:url value="/trainingPlan/trainingPlans"/>'
                       class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                            class="fas fa-download fa-sm text-white-50"></i>List of Training Plans</a>
                </div>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header">
                        <h6 class="m-0 font-weight-bold text-primary">Edit Training Plan</h6>
                    </div>
                    <div class="card-body">
                        <form:form method="post" modelAttribute="trainingPlan">
                            Name:
                            <form:input path="name"/><br/>
                            Description:
                            <form:textarea path="description"/><br/>
                            <input type="submit" value="SaveTrainingPlan">
                        </form:form>
                    </div>
                </div>
