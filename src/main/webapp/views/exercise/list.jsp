        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href='<c:url value="/exercise/add"/>'
                       class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                            class="fas fa-download fa-sm text-white-50"></i>Add an Exercise</a>
                </div>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header">
                        <h6 class="m-0 font-weight-bold text-primary">Exercises list</h6>
                    </div>
                    <div class="card-body">
                        <table class="table">
                            <tr>
                            ...
                            <c:forEach items="${exercises}" var="exercise">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="confirmDelete" href="/exercise/delete/${exercise.id}">Delete</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </table>
